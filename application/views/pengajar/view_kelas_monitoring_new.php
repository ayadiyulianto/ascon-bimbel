    ...
    <script>
      ...
      $(function(){
        ...
        $('.filemgr-content-header').children('nav').append(
          '<a href="<?=base_url('kelas/monitoringcetak')?>" class="btn btn-outline-secondary"><i class="fa fa-print" data-toggle="tooltip" data-placement="top" title="Cetak"></i> <span class="d-none d-md-inline">Cetak</span></a>');
