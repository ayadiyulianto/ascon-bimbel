                            ...
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    ...
                                    <div class="add-product">
                                        <a href="#" data-toggle="modal" data-target="#PrimaryModalhdbgcl">Tambah Akun Pengajar</a>
                                    </div>
                                    <div class="visible-xs">
                                        <a class="btn btn-primary" href="#" data-toggle="modal" data-target="#PrimaryModalhdbgcl">Tambah Akun Pengajar</a>
                                    </div>
                                    <hr>
                                </div>
                            </div>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $pengajar->jk ?></td>
                                                <td>
                                                    <a href="<?= base_url('admin/datamaster/formpengajar/'.$pengajar->id) ?>" data-toggle="tooltip" title="Ubah" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                                    <a href="<?= base_url('admin/datamaster/hapuspengajar/'.$pengajar->id) ?>" onclick="return confirm('Yakin ingin menghapus?')" data-toggle="tooltip" title="Hapus" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                                </td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="basic-login-inner modal-basic-inner">
                                        <form action="<?= base_url('admin/datamaster/tambahAkunPengajar') ?>" method="post" id="formTambah">
